...
import { useGetFMCandidatesQuery } from '../redux/slices/candidates/candidateSlice';
import { useVoteMutation } from '../redux/slices/votes/voteSlice';
import { Card } from 'flowbite-react';
import { Link } from 'react-router-dom';
import { toast } from "react-toastify";

const FinancialManagerCandidates = () => {
    const [candidates, setCandidates] = useState([]);
    const { data, isError, isLoading, error } = useGetFMCandidatesQuery();
    const [
        vote,
        { isError: isVotingError, error: votingError, isLoading: isVotingLoading },
    ] = useVoteMutation();
...
export default FinancialManagerCandidates;
